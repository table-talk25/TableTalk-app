...
export const MEAL_STATUS_COLORS = {
  [MEAL_STATUS.UPCOMING]: 'primary',  // Blu (usando le varianti di Bootstrap)
  [MEAL_STATUS.ONGOING]: 'success',   // Verde
  [MEAL_STATUS.COMPLETED]: 'secondary', // Grigio
  [MEAL_STATUS.CANCELLED]: 'danger'  // Rosso
};
